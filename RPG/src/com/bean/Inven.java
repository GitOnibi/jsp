...
public class Inven {
	...
	public Inven(String char_name, int item_code, String item_name, int item_atk, int item_def, int item_opt1,
			int item_opt2, int item_opt3, int item_opt4, int item_opt5, String item_sub, int item_prop,
			int item_price) {
